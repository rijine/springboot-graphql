 ...
 * @since 2018-04-06
 */
public class ExtDeleteBatchByIds extends AbstractExtMethod {

  @Override
  public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass,
      ExtTableInfo tableInfo) {
    String sql;
    ExtSqlMethod sqlMethod = ExtSqlMethod.LOGIC_DELETE_BATCH_BY_IDS;
    if (tableInfo.isLogicDelete()) {
      ...
      sqlMethod = ExtSqlMethod.DELETE_BATCH_BY_IDS;
      sql = String.format(sqlMethod.getSql(),
          tableInfo.getParentTableName(), tableInfo.getTableName(),
