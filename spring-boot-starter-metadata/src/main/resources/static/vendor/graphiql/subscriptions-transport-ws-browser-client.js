...
// easier to handle this case. if(!global) { ...}
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    (function (global) {
      ...
      var _global = typeof global !== 'undefined' ? global : (typeof window
      !== 'undefined' ? window : {});
      ...
      var SubscriptionClient = (function () {
        function SubscriptionClient(url, options, webSocketImpl) {
          var _a = (options || {}), _b = _a.connectionCallback,
              ...
              connectionParams = _c === void 0 ? {} : _c, _d = _a.timeout,
              timeout = _d === void 0 ? defaults_1.WS_TIMEOUT : _d,
              _e = _a.reconnect, reconnect = _e === void 0 ? false : _e,
              _f = _a.reconnectionAttempts,
              reconnectionAttempts = _f === void 0 ? Infinity : _f,
              _g = _a.lazy, lazy = _g === void 0 ? false : _g,
          ...
          if (this.client !== null) {
            ...
            if (isForced) {
              ...
              this.sendMessage(undefined,
                  message_types_1.default.GQL_CONNECTION_TERMINATE, null);
            }
            this.client.close();
            this.client = null;
        ...
        SubscriptionClient.prototype.on = function (eventName, callback,
            context) {
        ...
        SubscriptionClient.prototype.onConnected = function (callback,
            context) {
          return this.on('connected', callback, context);
        };
        SubscriptionClient.prototype.onConnecting = function (callback,
            context) {
          return this.on('connecting', callback, context);
        };
        SubscriptionClient.prototype.onDisconnected = function (callback,
            context) {
          return this.on('disconnected', callback, context);
        };
        SubscriptionClient.prototype.onReconnected = function (callback,
            context) {
          return this.on('reconnected', callback, context);
        };
        SubscriptionClient.prototype.onReconnecting = function (callback,
            context) {
        ...
        SubscriptionClient.prototype.executeOperation = function (options,
            handler) {
          var _this = this;
          if (this.client === null) {
            this.connect();
          ...
          .then(function (processedOptions) {
            ...
            if (_this.operations[opId]) {
              ...
              _this.sendMessage(opId, message_types_1.default.GQL_START,
                  processedOptions);
            }
          })
        ...
        SubscriptionClient.prototype.getObserver = function (observerOrNext,
            error, complete) {
        ...
        SubscriptionClient.prototype.setInactivityTimeout = function () {
          var _this = this;
          if (this.inactivityTimeout > 0 && Object.keys(this.operations).length
              === 0) {
        ...
        SubscriptionClient.prototype.checkOperationOptions = function (options,
            handler) {
          ...
          if ((!is_string_1.default(query)
              && !getOperationAST_1.getOperationAST(query, operationName)) ||
        ...
        SubscriptionClient.prototype.buildMessage = function (id, type,
            payload) {
          var payloadToReturn = payload && payload.query ? __assign({}, payload,
              {
                query: typeof payload.query === 'string' ? payload.query
                    : printer_1.print(payload.query)
              }) :
              payload;
          return {
            id: id,
        ...
        SubscriptionClient.prototype.sendMessage = function (id, type,
            payload) {
            ...
            case this.wsImpl.OPEN:
              ...
              try {
                ...
                this.eventEmitter.emit('error', new Error(
                    "Message must be JSON-serializable. Got: " + message));
              }
            ...
            default:
              if (!this.reconnecting) {
                this.eventEmitter.emit('error', new Error(
                    ...
                    +
                    'is already closed. Message was: ' + JSON.stringify(
                    message)));
              }
          }
        };
        ...
        SubscriptionClient.prototype.tryReconnect = function () {
          var _this = this;
          if (!this.reconnect || this.backoff.attempts
              >= this.reconnectionAttempts) {
            return;
          }
          if (!this.reconnecting) {
            Object.keys(this.operations).forEach(function (key) {
              _this.unsentMessagesQueue.push(
                  _this.buildMessage(key, message_types_1.default.GQL_START,
                      _this.operations[key].options));
            });
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    ...
                    this.sendMessage(undefined,
                        message_types_1.default.GQL_CONNECTION_INIT,
                        connectionParams);
                  ...
                  case 3:
                    error_1 = _a.sent();
                    this.sendMessage(undefined,
                        message_types_1.default.GQL_CONNECTION_ERROR, error_1);
                    this.flushUnsentMessagesQueue();
                    return [3, 4];
                  case 4:
                    return [2];
        ...
        SubscriptionClient.prototype.processReceivedData = function (receivedData) {
          ...
          try {
            ...
            throw new Error(
                "Message must be JSON-parseable. Got: " + receivedData);
          }
          ...
          switch (parsedMessage.type) {
            ...
            case message_types_1.default.GQL_ERROR:
              this.operations[opId].handler(
                  this.formatErrors(parsedMessage.payload), null);
              delete this.operations[opId];
              break;
            case message_types_1.default.GQL_DATA:
              var parsedPayload = !parsedMessage.payload.errors ?
                  parsedMessage.payload : __assign({}, parsedMessage.payload, {
            ...
            case message_types_1.default.GQL_CONNECTION_KEEP_ALIVE:
              ...
              this.checkConnectionIntervalId = setInterval(
                  this.checkConnection.bind(this), this.wsTimeout);
              break;
            default:
...
//
    ...
    EventEmitter.prototype.emit = function emit(event, a1, a2, a3, a4, a5) {
      ...
      if (listeners.fn) {
        ...
        for (i = 0; i < length; i++) {
          if (listeners[i].once) {
            this.removeListener(event, listeners[i].fn,
                undefined, true);
          }
    ...
    EventEmitter.prototype.removeListener = function removeListener(event, fn,
      ...
      if (listeners.fn) {
        ...
        for (var i = 0, events = [], length = listeners.length; i < length;
            i++) {
          if (
              listeners[i].fn !== fn ||
        ...
        //
        if (events.length) {
          this._events[evt] = events.length === 1 ? events[0]
              : events;
        } else {
          clearEvent(this, evt);
        }
...
//# sourceMappingURL=is-object.js.map
    ...
    var printDocASTReducer = {
      ...
      FragmentDefinition: function FragmentDefinition(_ref7) {
        ...
        return (// Note: fragment variable definitions are experimental and may be changed
            ...
            "fragment ".concat(name).concat(
                wrap('(', join(variableDefinitions, ', '), ')'), " ")
            + "on ".concat(typeCondition, " ").concat(
                wrap('', join(directives, ' '), ' ')) + selectionSet
        );
      },
      // Value
      ...
      StringValue: function StringValue(_ref10, key) {
        ...
        return isBlockString ? printBlockString(value, key === 'description')
      ...
      UnionTypeDefinition: addDescription(function (_ref27) {
        var name = _ref27.name,
            ...
            types = _ref27.types;
        return join(['union', name, join(directives, ' '),
      ...
      ObjectTypeExtension: function ObjectTypeExtension(_ref34) {
        ...
        return join(
            ['extend type', name, wrap('implements ', join(interfaces, ' & ')),
              join(directives, ' '), block(fields)], ' ');
      },
      ...
      UnionTypeExtension: function UnionTypeExtension(_ref36) {
        var name = _ref36.name,
            ...
            types = _ref36.types;
        return join(['extend union', name, join(directives, ' '),
          types && types.length !== 0 ? '= ' + join(types, ' | ') : ''], ' ');
      },
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var QueryDocumentKeys = {
      ...
      ObjectTypeDefinition: ['description', 'name', 'interfaces', 'directives',
        'fields'],
      FieldDefinition: ['description', 'name', 'arguments', 'type',
        'directives'],
      ...
      InputObjectTypeDefinition: ['description', 'name', 'directives',
        'fields'],
    ...
    function visit(root, visitor) {
      var visitorKeys = arguments.length > 2 && arguments[2] !== undefined
          ? arguments[2] : QueryDocumentKeys;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function inspect(value) {
      switch (_typeof(value)) {
        ...
        case 'function':
          return value.name ? "[function ".concat(value.name, "]")
              : '[function]';
  ...
  /***/ (function (module, __webpack_exports__, __webpack_require__) {
    ...
    (function (global, module) {/* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(13);
      /* global window */
      ...
      var result = Object(
          __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__["a" /* default */])(root);
