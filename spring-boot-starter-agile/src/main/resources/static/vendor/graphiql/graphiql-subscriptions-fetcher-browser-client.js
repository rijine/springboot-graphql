...
// Predicates & Assertions
    ...
    function isType(type) {
      return type instanceof GraphQLScalarType || type
          instanceof GraphQLObjectType || type instanceof GraphQLInterfaceType
          || type instanceof GraphQLUnionType || type instanceof GraphQLEnumType
          || type instanceof GraphQLInputObjectType || type
          instanceof GraphQLList || type instanceof GraphQLNonNull;
    }
    ...
    function isInputType(type) {
      ...
      return namedType instanceof GraphQLScalarType || namedType
          instanceof GraphQLEnumType || namedType
          instanceof GraphQLInputObjectType;
    }

    function assertInputType(type) {
      (0, _invariant2.default)(isInputType(type),
    ...
    function isOutputType(type) {
      var namedType = getNamedType(type);
      return namedType instanceof GraphQLScalarType || namedType
          instanceof GraphQLObjectType || namedType
          instanceof GraphQLInterfaceType || namedType
          instanceof GraphQLUnionType || namedType instanceof GraphQLEnumType;
    }

    function assertOutputType(type) {
      (0, _invariant2.default)(isOutputType(type),
    ...
    function assertLeafType(type) {
      (0, _invariant2.default)(isLeafType(type),
    ...
    function isCompositeType(type) {
      return type instanceof GraphQLObjectType || type
          instanceof GraphQLInterfaceType || type instanceof GraphQLUnionType;
    }
    ...
    function isAbstractType(type) {
      return type instanceof GraphQLInterfaceType || type
    ...
    function assertNamedType(type) {
      (0, _invariant2.default)(isNamedType(type),
    ...
    function getNamedType(type) {
      ...
      while (unmodifiedType instanceof GraphQLList || unmodifiedType
    ...
    var GraphQLScalarType = exports.GraphQLScalarType = function () {
      function GraphQLScalarType(config) {
        ...
        if (config.parseValue || config.parseLiteral) {
          (0, _invariant2.default)(typeof config.parseValue === 'function'
...
// Also provide toJSON and inspect aliases for toString.
    ...
    var GraphQLObjectType = exports.GraphQLObjectType = function () {
      ...
      GraphQLObjectType.prototype.getFields = function getFields() {
        return this._fields || (this._fields = defineFieldMap(this,
            this._typeConfig.fields));
      };

      GraphQLObjectType.prototype.getInterfaces = function getInterfaces() {
        return this._interfaces || (this._interfaces = defineInterfaces(this,
            this._typeConfig.interfaces));
      };
...
// Also provide toJSON and inspect aliases for toString.
    ...
    function defineInterfaces(type, interfacesThunk) {
      ...
      (0, _invariant2.default)(Array.isArray(interfaces), type.name
      ...
      interfaces.forEach(function (iface) {
        ...
        if (typeof iface.resolveType !== 'function') {
          (0, _invariant2.default)(typeof type.isTypeOf === 'function',
              'Interface Type ' + iface.name
              + ' does not provide a "resolveType" '
              + ('function and implementing Type ' + type.name
              + ' does not provide a ')
...
// Also provide toJSON and inspect aliases for toString.
    ...
    var GraphQLUnionType = exports.GraphQLUnionType = function () {
      ...
      GraphQLUnionType.prototype.getTypes = function getTypes() {
        return this._types || (this._types = defineTypes(this,
    ...
    function defineTypes(unionType, typesThunk) {
      ...
      types.forEach(function (objType) {
        (0, _invariant2.default)(objType instanceof GraphQLObjectType,
            unionType.name
            + ' may only contain Object types, it cannot contain: ' + (String(
            objType) + '.'));
        if (typeof unionType.resolveType !== 'function') {
          (0, _invariant2.default)(typeof objType.isTypeOf === 'function',
              'Union type "' + unionType.name
              + '" does not provide a "resolveType" '
              + ('function and possible type "' + objType.name
              + '" does not provide an ')
...
// Also provide toJSON and inspect aliases for toString.
    ...
    function defineEnumValues(type, valueMap /* <T> */
      ...
      return valueNames.map(function (valueName) {
        ...
        (0, _invariant2.default)(isPlainObj(value), type.name + '.' + valueName
    ...
    var GraphQLInputObjectType = exports.GraphQLInputObjectType = function () {
      ...
      GraphQLInputObjectType.prototype._defineFieldMap = function _defineFieldMap() {
        ...
        (0, _invariant2.default)(isPlainObj(fieldMap), this.name
            + ' fields must be an object with field names as keys or a '
            + 'function which returns such an object.');
        var fieldNames = Object.keys(fieldMap);
        (0, _invariant2.default)(fieldNames.length > 0, this.name
            + ' fields must be an object with field names as keys or a '
            + 'function which returns such an object.');
        var resultFieldMap = {};
        fieldNames.forEach(function (fieldName) {
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var printDocASTReducer = {
      ...
      InlineFragment: function InlineFragment(_ref6) {
        ...
        return join(['...', wrap('on ', typeCondition), join(directives, ' '),
          selectionSet], ' ');
      },
      ...
      FragmentDefinition: function FragmentDefinition(_ref7) {
        ...
        return 'fragment ' + name + ' on ' + typeCondition + ' ' + wrap('',
            join(directives, ' '), ' ') + selectionSet;
      },
      ...
      ObjectTypeDefinition: function ObjectTypeDefinition(_ref23) {
        ...
        return join(['type', name, wrap('implements ', join(interfaces, ', ')),
      ...
      FieldDefinition: function FieldDefinition(_ref24) {
        ...
        return name + wrap('(', join(args, ', '), ')') + ': ' + type + wrap(' ',
            join(directives, ' '));
      },
      ...
      InputValueDefinition: function InputValueDefinition(_ref25) {
        ...
        return join([name + ': ' + type, wrap('= ', defaultValue),
          join(directives, ' ')], ' ');
      },
      ...
      DirectiveDefinition: function DirectiveDefinition(_ref32) {
        ...
        return 'directive @' + name + wrap('(', join(args, ', '), ')') + ' on '
            + join(locations, ' | ');
      }
    };
...
// eslint-disable-line
    ...
    var GraphQLDirective = exports.GraphQLDirective = function GraphQLDirective(config) {
      ...
      (0, _assertValidName.assertValidName)(config.name);
      (0, _invariant2.default)(Array.isArray(config.locations),
      ...
      if (!args) {
        ...
        (0, _invariant2.default)(!Array.isArray(args), '@' + config.name
            + ' args must be an object with argument names as keys.');
     ...
     */
    var specifiedDirectives = exports.specifiedDirectives = [GraphQLIncludeDirective,
...
// they are internally represented as IEEE 754 doubles.
    ...
    function coerceInt(value) {
      ...
      throw new TypeError(
          'Int cannot represent non 32-bit signed integer value: ' + String(
          value));
    }
    ...
    var GraphQLID = exports.GraphQLID = new _definition.GraphQLScalarType({
      ...
      parseValue: String,
      parseLiteral: function parseLiteral(ast) {
        return ast.kind === Kind.STRING || ast.kind === Kind.INT ? ast.value
            : null;
      }
    });
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var GraphQLSchema = exports.GraphQLSchema = function () {
      function GraphQLSchema(config) {
        ...
        (0, _invariant2.default)(typeof config === 'object',
        ...
        (0, _invariant2.default)(!config.mutation || config.mutation
            instanceof _definition.GraphQLObjectType,
            'Schema mutation must be Object Type if provided but got: '
            + String(config.mutation) + '.');
        this._mutationType = config.mutation;

        (0, _invariant2.default)(!config.subscription || config.subscription
            instanceof _definition.GraphQLObjectType,
        ...
        var initialTypes = [this.getQueryType(), this.getMutationType(),
          this.getSubscriptionType(), _introspection.__Schema];
        ...
        this._typeMap = initialTypes.reduce(typeMapReducer,
            Object.create(null));
      ...
      GraphQLSchema.prototype.isPossibleType = function isPossibleType(abstractType,
          possibleType) {
    ...
    function typeMapReducer(map, type) {
      ...
      if (type instanceof _definition.GraphQLList || type
          instanceof _definition.GraphQLNonNull) {
    ...
    function assertObjectImplementsInterface(schema, object, iface) {
      ...
      Object.keys(ifaceFieldMap).forEach(function (fieldName) {
        ...
        (0, _invariant2.default)(objectField,
            '"' + iface.name + '" expects field "' + fieldName + '" but "'
            + object.name + '" ' + 'does not provide it.');

        // Assert interface field type is satisfied by object field type, by being
        // a valid subtype. (covariant)
        (0, _invariant2.default)(
            (0, _typeComparators.isTypeSubTypeOf)(schema, objectField.type,
                ifaceField.type),
            iface.name + '.' + fieldName + ' expects type "' + String(
            ifaceField.type) + '" ' + 'but ' + (object.name + '.' + fieldName
            + ' provides type "' + String(objectField.type) + '".'));
        ...
        ifaceField.args.forEach(function (ifaceArg) {
          ...
          (0, _invariant2.default)(objectArg,
              iface.name + '.' + fieldName + ' expects argument "' + argName
              + '" but ' + (object.name + '.' + fieldName
              + ' does not provide it.'));

          // Assert interface field arg type matches object field arg type.
          // (invariant)
          (0, _invariant2.default)(
              (0, _typeComparators.isEqualType)(ifaceArg.type, objectArg.type),
              iface.name + '.' + fieldName + '(' + argName + ':) expects type '
              + ('"' + String(ifaceArg.type) + '" but ') + (object.name + '.'
              + fieldName + '(' + argName + ':) provides type ') + ('"'
        ...
        objectField.args.forEach(function (objectArg) {
          ...
          if (!ifaceArg) {
            (0, _invariant2.default)(
                !(objectArg.type instanceof _definition.GraphQLNonNull),
                object.name + '.' + fieldName + '(' + argName
                + ':) is of required type ' + ('"' + String(objectArg.type)
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function typeFromAST(schema, typeNode) {
      ...
      (0, _invariant2.default)(typeNode.kind === _kinds.NAMED_TYPE,
      ...
      fields: function fields() {
        return {
          types: {
            ...
            type: new _definition.GraphQLNonNull(new _definition.GraphQLList(
        ...
        return {
          ...
          onOperation: {
            ...
            resolve: function resolve(d) {
              return d.locations.indexOf(_directives.DirectiveLocation.QUERY)
                  !== -1 || d.locations.indexOf(
                      _directives.DirectiveLocation.MUTATION) !== -1
                  || d.locations.indexOf(
          ...
          onFragment: {
            ...
            type: new _definition.GraphQLNonNull(_scalars.GraphQLBoolean),
            resolve: function resolve(d) {
              return d.locations.indexOf(
                  _directives.DirectiveLocation.FRAGMENT_SPREAD) !== -1
                  || d.locations.indexOf(
                      _directives.DirectiveLocation.INLINE_FRAGMENT) !== -1
                  || d.locations.indexOf(
                      _directives.DirectiveLocation.FRAGMENT_DEFINITION) !== -1;
            }
          },
          onField: {
            deprecationReason: 'Use `locations`.',
            type: new _definition.GraphQLNonNull(_scalars.GraphQLBoolean),
            resolve: function resolve(d) {
              return d.locations.indexOf(_directives.DirectiveLocation.FIELD)
                  !== -1;
            }
          }
        };
            ...
            return {
              ...
              defaultValue: {
                ...
                resolve: function resolve(inputVal) {
                  return (0, _isInvalid2.default)(inputVal.defaultValue) ? null
                      : (0, _printer.print)(
                          (0, _astFromValue.astFromValue)(inputVal.defaultValue,
                              inputVal.type));
                }
              }
            };
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    var QueryDocumentKeys = exports.QueryDocumentKeys = {
      ...
      OperationDefinition: ['name', 'variableDefinitions', 'directives',
        'selectionSet'],
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function valueFromAST(valueNode, type, variables) {
      ...
      if (type instanceof _definition.GraphQLInputObjectType) {
        ...
        var fieldNodes = (0, _keyMap2.default)(valueNode.fields,
            function (field) {
      ...
      (0, _invariant2.default)(
          type instanceof _definition.GraphQLScalarType || type
          instanceof _definition.GraphQLEnumType, 'Must be input type');
...
// in the set of variables.
    function isMissingVariable(valueNode, variables) {
      return valueNode.kind === Kind.VARIABLE && (!variables
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function parse(source, options) {
      var sourceObj = typeof source === 'string' ? new _source.Source(source)
          : source;
...
// Implements the parsing rules in the Operations section.
    ...
    function parseVariableDefinitions(lexer) {
      return peek(lexer, _lexer.TokenKind.PAREN_L) ? many(lexer,
          _lexer.TokenKind.PAREN_L, parseVariableDefinition,
    ...
    function parseVariableDefinition(lexer) {
      ...
      return {
        ...
        type: (expect(lexer, _lexer.TokenKind.COLON), parseTypeReference(
            lexer)),
        defaultValue: skip(lexer, _lexer.TokenKind.EQUALS) ? parseValueLiteral(
            lexer, true) : null,
        loc: loc(lexer, start)
      };
    }
    ...
    function parseSelectionSet(lexer) {
      ...
      return {
        ...
        selections: many(lexer, _lexer.TokenKind.BRACE_L, parseSelection,
    ...
    function parseSelection(lexer) {
      return peek(lexer, _lexer.TokenKind.SPREAD) ? parseFragment(lexer)
          : parseField(lexer);
    }
    ...
    function parseField(lexer) {
      ...
      return {
        ...
        directives: parseDirectives(lexer),
        selectionSet: peek(lexer, _lexer.TokenKind.BRACE_L) ? parseSelectionSet(
            lexer) : null,
        loc: loc(lexer, start)
      };
    }
    ...
    function parseArguments(lexer) {
      return peek(lexer, _lexer.TokenKind.PAREN_L) ? many(lexer,
          _lexer.TokenKind.PAREN_L, parseArgument, _lexer.TokenKind.PAREN_R)
          : [];
    }
    ...
    function parseArgument(lexer) {
      ...
      return {
        ...
        name: parseName(lexer),
        value: (expect(lexer, _lexer.TokenKind.COLON), parseValueLiteral(lexer,
            false)),
        loc: loc(lexer, start)
      };
    }
...
// Implements the parsing rules in the Values section.
    ...
    function parseList(lexer, isConst) {
      ...
      return {
        kind: _kinds.LIST,
        values: any(lexer, _lexer.TokenKind.BRACKET_L, item,
...
// Implements the parsing rules in the Type Definition section.
    ...
    function parseSchemaDefinition(lexer) {
      ...
      var operationTypes = many(lexer, _lexer.TokenKind.BRACE_L,
          parseOperationTypeDefinition, _lexer.TokenKind.BRACE_R);
      return {
    ...
    function parseObjectTypeDefinition(lexer) {
      ...
      var directives = parseDirectives(lexer);
      var fields = any(lexer, _lexer.TokenKind.BRACE_L, parseFieldDefinition,
          _lexer.TokenKind.BRACE_R);
      return {
    ...
    function parseArgumentDefs(lexer) {
      ...
      return many(lexer, _lexer.TokenKind.PAREN_L, parseInputValueDef,
          _lexer.TokenKind.PAREN_R);
    }
    ...
    function parseEnumTypeDefinition(lexer) {
      ...
      var name = parseName(lexer);
      var directives = parseDirectives(lexer);
      var values = many(lexer, _lexer.TokenKind.BRACE_L,
          parseEnumValueDefinition, _lexer.TokenKind.BRACE_R);
      return {
    ...
    function parseInputObjectTypeDefinition(lexer) {
      ...
      var name = parseName(lexer);
      var directives = parseDirectives(lexer);
      var fields = any(lexer, _lexer.TokenKind.BRACE_L, parseInputValueDef,
          _lexer.TokenKind.BRACE_R);
      return {
...
// Print a simplified form when appearing in JSON/util.inspect.
    ...
    function unexpected(lexer, atToken) {
      ...
      return (0, _error.syntaxError)(lexer.source, token.start,
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function isValidLiteralValue(type, valueNode) {
        ...
        var _ret2 = function () {
          ...
          fieldNodes.forEach(function (providedFieldNode) {
            if (!fields[providedFieldNode.name.value]) {
              errors.push('In field "' + providedFieldNode.name.value
                  + '": Unknown field.');
            }
          });

          // Ensure every defined field is valid.
          var fieldNodeMap = (0, _keyMap2.default)(fieldNodes,
              function (fieldNode) {
      ...
      if ((0, _isNullish2.default)(parseResult)) {
        return ['Expected type "' + type.name + '", found '
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function isEqualType(typeA, typeB) {
      ...
      if (typeA instanceof _definition.GraphQLNonNull && typeB
          instanceof _definition.GraphQLNonNull) {
        return isEqualType(typeA.ofType, typeB.ofType);
      }

      // If either type is a list, the other must also be a list.
      if (typeA instanceof _definition.GraphQLList && typeB
          instanceof _definition.GraphQLList) {
        return isEqualType(typeA.ofType, typeB.ofType);
      }
    ...
    function isTypeSubTypeOf(schema, maybeSubType, superType) {
      ...
      if ((0, _definition.isAbstractType)(superType) && maybeSubType
          instanceof _definition.GraphQLObjectType && schema.isPossibleType(
    ...
    function doTypesOverlap(schema, typeA, typeB) {
      ...
      if (typeA instanceof _definition.GraphQLInterfaceType || typeA
          instanceof _definition.GraphQLUnionType) {
        if (_typeB instanceof _definition.GraphQLInterfaceType || _typeB
            instanceof _definition.GraphQLUnionType) {
...
// In ES2015 (or a polyfilled) environment, this will be Symbol.iterator
    ...
    function getIteratorMethod(iterable) {
      if (iterable != null) {
        var method = SYMBOL_ITERATOR && iterable[SYMBOL_ITERATOR]
            || iterable['@@iterator']
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function quotedOrList(items) {
      ...
      return selected.map(function (item) {
        ...
        return list + (selected.length > 2 ? ', ' : ' ') + (index
        === selected.length - 1 ? 'or ' : '') + quoted;
      });
    }
    ...
    function lexicalDistance(a, b) {
      ...
      for (i = 1; i <= aLength; i++) {
        for (j = 1; j <= bLength; j++) {
          ...
          if (i > 1 && j > 1 && a[i - 1] === b[j - 2] && a[i - 2] === b[j
          - 1]) {
...
// Print a simplified form when appearing in JSON/util.inspect.
    ...
    function readToken(lexer, prev) {
      ...
      // SourceCharacter
      if (code < 0x0020 && code !== 0x0009 && code !== 0x000A && code
          !== 0x000D) {
      ...
      switch (code) {
        ...
        case 41:
          ...
          // .
        case 46:
          if (charCodeAt.call(body, position + 1) === 46 && charCodeAt.call(
              body, position + 2) === 46) {
    ...
    function readComment(source, start, line, col, prev) {
      ...
      return new Tok(COMMENT, start, position, line, col, prev,
    ...
    function readNumber(source, start, firstCode, line, col, prev) {
      ...
      return new Tok(isFloat ? FLOAT : INT, start, position, line, col, prev,
    ...
    function readString(source, start, line, col, prev) {
      ...
      while (position < body.length && (code = charCodeAt.call(body, position))
      !== null &&
      // not LineTerminator
      ...
      code !== 34) {
        ...
        if (code === 92) {
          ...
          switch (code) {
            ...
            case 117:
              // u
              var charCode = uniCharCode(charCodeAt.call(body, position + 1),
                  charCodeAt.call(body, position + 2),
                  charCodeAt.call(body, position + 3),
                  charCodeAt.call(body, position + 4));
              if (charCode < 0) {
                throw (0, _error.syntaxError)(source, position,
                    'Invalid character escape sequence: ' + ('\\u' + body.slice(
    ...
    function uniCharCode(a, b, c, d) {
      return char2hex(a) << 12 | char2hex(b) << 8 | char2hex(c) << 4 | char2hex(
          d);
    }
    ...
    function readName(source, position, line, col, prev) {
      ...
      var end = position + 1;
      var code = 0;
      while (end !== bodyLength && (code = charCodeAt.call(body, end)) !== null
      && (code === 95 || // _
          code >= 48 && code <= 57 || // 0-9
          code >= 65 && code <= 90 || // A-Z
      ...
      return new Tok(NAME, position, end, line, col, prev,
  ...
  /***/ (function (module, exports, __webpack_require__) {
      ...
      TypeInfo.prototype.enter = function enter(node /* ASTNode */) {
        ...
        switch (node.kind) {
          ...
          case Kind.FRAGMENT_DEFINITION:
            ...
            var outputType = typeConditionAST ? (0, _typeFromAST.typeFromAST)(
                schema, typeConditionAST) : this.getType();
          ...
          case Kind.ARGUMENT:
            ...
            if (fieldOrDirective) {
              argDef = (0, _find2.default)(fieldOrDirective.args,
                  function (arg) {
          ...
          case Kind.LIST:
            ...
            this._inputTypeStack.push(
                listType instanceof _definition.GraphQLList ? listType.ofType
                    : undefined);
            break;
    ...
    function getFieldDef(schema, parentType, fieldNode) {
      ...
      if (name === _introspection.SchemaMetaFieldDef.name
          && schema.getQueryType() === parentType) {
        return _introspection.SchemaMetaFieldDef;
      }
      if (name === _introspection.TypeMetaFieldDef.name && schema.getQueryType()
          === parentType) {
        return _introspection.TypeMetaFieldDef;
      }
      if (name === _introspection.TypeNameMetaFieldDef.name && (parentType
          instanceof _definition.GraphQLObjectType || parentType
          instanceof _definition.GraphQLInterfaceType || parentType
          instanceof _definition.GraphQLUnionType)) {
...
// Ensures console warnings are only issued once.
    ...
    function assertValidName(name, isIntrospection) {
      ...
      if (!isIntrospection && name.slice(0, 2) === '__'
        ...
        if (console && console.error) {
          var error = new Error('Name "' + name
              + '" must not begin with "__", which is reserved by '
      ...
      if (!NAME_RX.test(name)) {
        throw new Error(
            'Names must match /^[_a-zA-Z][_a-zA-Z0-9]*$/ but "' + name
            + '" does not.');
      }
    }
    ...
    function astFromValue(value, type) {
      ...
      if (typeof serialized === 'number') {
        ...
        return (/^[0-9]+$/.test(stringNum) ? {
              kind: _kinds.INT,
              value: stringNum
            } : {kind: _kinds.FLOAT, value: stringNum}
        );
      }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function execute(schema, document, rootValue, contextValue, variableValues,
        operationName) {
      ...
      var context = buildExecutionContext(schema, document, rootValue,
     ...
     */
    function buildExecutionContext(schema, document, rootValue, contextValue,
        rawVariableValues, operationName) {
      var errors = [];
      ...
      document.definitions.forEach(function (definition) {
        switch (definition.kind) {
          case Kind.OPERATION_DEFINITION:
            ...
            if (!operationName || definition.name && definition.name.value
                === operationName) {
      ...
      var variableValues = (0, _values.getVariableValues)(schema,
          operation.variableDefinitions || [], rawVariableValues || {});
    ...
    function getOperationRootType(schema, operation) {
      switch (operation.operation) {
        ...
        case 'mutation':
          ...
          if (!mutationType) {
            throw new _error.GraphQLError(
                'Schema is not configured for mutations', [operation]);
          }
          return mutationType;
        case 'subscription':
     ...
     * for "write" mode.
     */
    function executeFieldsSerially(exeContext, parentType, sourceValue, path,
        fields) {
      return Object.keys(fields).reduce(function (prevPromise, responseName) {
        return prevPromise.then(function (results) {
          var fieldNodes = fields[responseName];
          var fieldPath = addPath(path, responseName);
          var result = resolveField(exeContext, parentType, sourceValue,
     ...
     */
    function collectFields(exeContext, runtimeType, selectionSet, fields,
      ...
      for (var i = 0; i < selectionSet.selections.length; i++) {
        ...
        switch (selection.kind) {
          ...
          case Kind.INLINE_FRAGMENT:
            if (!shouldIncludeNode(exeContext, selection.directives)
                || !doesFragmentConditionMatch(exeContext, selection,
                    runtimeType)) {
              continue;
            }
            collectFields(exeContext, runtimeType, selection.selectionSet,
          ...
          case Kind.FRAGMENT_SPREAD:
            ...
            if (!fragment || !doesFragmentConditionMatch(exeContext, fragment,
                runtimeType)) {
              continue;
            }
            collectFields(exeContext, runtimeType, fragment.selectionSet,
                fields, visitedFragmentNames);
            break;
        }
      }
    ...
    function shouldIncludeNode(exeContext, directives) {
      var skipNode = directives && (0, _find2.default)(directives,
          function (directive) {
            return directive.name.value
                === _directives.GraphQLSkipDirective.name;
          });
      if (skipNode) {
        var _getArgumentValues = (0, _values.getArgumentValues)(
            _directives.GraphQLSkipDirective, skipNode,
      ...
      var includeNode = directives && (0, _find2.default)(directives,
          function (directive) {
            return directive.name.value
                === _directives.GraphQLIncludeDirective.name;
          });
      if (includeNode) {
        var _getArgumentValues2 = (0, _values.getArgumentValues)(
            _directives.GraphQLIncludeDirective, includeNode,
            exeContext.variableValues),
    ...
    function doesFragmentConditionMatch(exeContext, fragment, type) {
      ...
      var conditionalType = (0, _typeFromAST.typeFromAST)(exeContext.schema,
          typeConditionNode);
    ...
    function resolveField(exeContext, parentType, source, fieldNodes, path) {
      ...
      // or abrupt (error).
      var result = resolveOrError(exeContext, fieldDef, fieldNode, resolveFn,
          source, context, info);

      return completeValueCatchingError(exeContext, returnType, fieldNodes,
          info, path, result);
    }

// Isolates the "ReturnOrAbrupt" behavior to not de-opt the `resolveField`
// function. Returns the result of resolveFn or the abrupt-return Error object.
    function resolveOrError(exeContext, fieldDef, fieldNode, resolveFn, source,
        context, info) {
      try {
        // Build a JS object of arguments from the field.arguments AST, using the
        // variables scope to fulfill any variable references.
        // TODO: find a way to memoize, in case this field is within a List type.
        var args = (0, _values.getArgumentValues)(fieldDef, fieldNode,
            exeContext.variableValues);
...
// in the execution context.
    function completeValueCatchingError(exeContext, returnType, fieldNodes,
      ...
      if (returnType instanceof _definition.GraphQLNonNull) {
        return completeValueWithLocatedError(exeContext, returnType, fieldNodes,
            info, path, result);
      }
      ...
      try {
        var completed = completeValueWithLocatedError(exeContext, returnType,
...
// location information.
    function completeValueWithLocatedError(exeContext, returnType, fieldNodes,
        info, path, result) {
      try {
        var completed = completeValue(exeContext, returnType, fieldNodes, info,
            path, result);
        if (isThenable(completed)) {
          return completed.then(undefined, function (error) {
            return Promise.reject((0, _error.locatedError)(error, fieldNodes,
                responsePathAsArray(path)));
          });
        }
        return completed;
      } catch (error) {
        throw (0, _error.locatedError)(error, fieldNodes,
            responsePathAsArray(path));
      }
    }
     ...
     */
    function completeValue(exeContext, returnType, fieldNodes, info, path,
        result) {
      // If result is a Promise, apply-lift over completeValue.
      if (isThenable(result)) {
        return result.then(function (resolved) {
          return completeValue(exeContext, returnType, fieldNodes, info, path,
              resolved);
        });
      }
      ...
      if (returnType instanceof _definition.GraphQLList) {
        return completeListValue(exeContext, returnType, fieldNodes, info, path,
            result);
      }
     ...
     * inner type
     */
    function completeListValue(exeContext, returnType, fieldNodes, info, path,
        result) {
      ...
      (0, _iterall.forEach)(result, function (item, index) {
        ...
        var completedItem = completeValueCatchingError(exeContext, itemType,
    ...
    function completeLeafValue(returnType, result) {
      (0, _invariant2.default)(returnType.serialize,
    ...
    function completeAbstractValue(exeContext, returnType, fieldNodes, info,
        path, result) {
      var runtimeType = returnType.resolveType ? returnType.resolveType(result,
          exeContext.contextValue, info) : defaultResolveTypeFn(result,
          exeContext.contextValue, info, returnType);
      ...
      if (isThenable(runtimeType)) {
        ...
        return runtimeTypePromise.then(function (resolvedRuntimeType) {
          return completeObjectValue(exeContext,
              ensureValidRuntimeType(resolvedRuntimeType, exeContext,
                  returnType, fieldNodes, info, result), fieldNodes, info, path,
              result);
        });
      }

      return completeObjectValue(exeContext,
          ensureValidRuntimeType(runtimeType, exeContext, returnType,
              fieldNodes, info, result), fieldNodes, info, path, result);
    }

    function ensureValidRuntimeType(runtimeTypeOrName, exeContext, returnType,
        fieldNodes, info, result) {
      var runtimeType = typeof runtimeTypeOrName === 'string'
          ? exeContext.schema.getType(runtimeTypeOrName) : runtimeTypeOrName;

      if (!(runtimeType instanceof _definition.GraphQLObjectType)) {
        throw new _error.GraphQLError('Abstract type ' + returnType.name
            + ' must resolve to an Object type at ' + ('runtime for field '
                + info.parentType.name + '.' + info.fieldName + ' with ')
            + ('value "' + String(result) + '", received "' + String(
                runtimeType) + '".'), fieldNodes);
      }

      if (!exeContext.schema.isPossibleType(returnType, runtimeType)) {
        throw new _error.GraphQLError('Runtime Object type "' + runtimeType.name
     ...
     */
    function completeObjectValue(exeContext, returnType, fieldNodes, info, path,
        result) {
      ...
      if (returnType.isTypeOf) {
        ...
        if (isThenable(isTypeOf)) {
          return isTypeOf.then(function (isTypeOfResult) {
            ...
            return collectAndExecuteSubfields(exeContext, returnType,
                fieldNodes, info, path, result);
          });
        }
    ...
    function invalidReturnTypeError(returnType, result, fieldNodes) {
      return new _error.GraphQLError(
          'Expected value of type "' + returnType.name + '" but got: ' + String(
          result) + '.', fieldNodes);
    }
    ...
    function collectAndExecuteSubfields(exeContext, returnType, fieldNodes,
      ...
      for (var i = 0; i < fieldNodes.length; i++) {
        ...
        if (selectionSet) {
          subFieldNodes = collectFields(exeContext, returnType, selectionSet,
              subFieldNodes, visitedFragmentNames);
        }
      }
     ...
     */
    var defaultFieldResolver = exports.defaultFieldResolver = function defaultFieldResolver(source,
        args, context, info) {
    ...
    function isThenable(value) {
      return typeof value === 'object' && value !== null && typeof value.then
          === 'function';
    }
    ...
    function getFieldDef(schema, parentType, fieldName) {
      if (fieldName === _introspection.SchemaMetaFieldDef.name
          && schema.getQueryType() === parentType) {
        return _introspection.SchemaMetaFieldDef;
      } else if (fieldName === _introspection.TypeMetaFieldDef.name
          && schema.getQueryType() === parentType) {
        return _introspection.TypeMetaFieldDef;
        ...
        if ((0, _isInvalid2.default)(value)) {
          ...
          if (defaultValue) {
            coercedValues[varName] = (0, _valueFromAST.valueFromAST)(
                defaultValue, varType);
          }
          if (varType instanceof _definition.GraphQLNonNull) {
            throw new _error.GraphQLError(
                'Variable "$' + varName + '" of required type ' + ('"' + String(
          ...
          if (errors.length) {
            ...
            throw new _error.GraphQLError(
                ...
                + (JSON.stringify(value) + '.' + message), [varDefNode]);
          }

          var coercedValue = coerceValue(varType, value);
          (0, _invariant2.default)(!(0, _isInvalid2.default)(coercedValue),
    ...
    function getArgumentValues(def, node, variableValues) {
      ...
      for (var i = 0; i < argDefs.length; i++) {
        ...
        if (!argumentNode) {
          ...
          if (variableValues && !(0, _isInvalid2.default)(
          ...
          var coercedValue = (0, _valueFromAST.valueFromAST)(valueNode, argType,
              variableValues);
          if ((0, _isInvalid2.default)(coercedValue)) {
            ...
            throw new _error.GraphQLError(
                ...
                + (0, _printer.print)(valueNode) + '.' + message,
                [argumentNode.value]);
          }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function getNamedTypeNode(typeNode) {
      ...
      while (namedType.kind === _kinds.LIST_TYPE || namedType.kind
      === _kinds.NON_NULL_TYPE) {
    ...
    function buildASTSchema(ast) {
      ...
      if (schemaDef) {
        schemaDef.operationTypes.forEach(function (operationType) {
          ...
          if (operationType.operation === 'query') {
            ...
            if (!nodeMap[typeName]) {
              throw new Error('Specified query type "' + typeName
            ...
            if (!nodeMap[typeName]) {
              throw new Error('Specified mutation type "' + typeName
                  + '" not found in document.');
            }
            ...
            if (!nodeMap[typeName]) {
              throw new Error('Specified subscription type "' + typeName
                  + '" not found in document.');
            }
      ...
      return new _schema.GraphQLSchema({
        ...
        mutation: mutationTypeName ? getObjectType(nodeMap[mutationTypeName])
            : null,
        subscription: subscriptionTypeName ? getObjectType(
            nodeMap[subscriptionTypeName]) : null,
        types: types,
        directives: directives
      });
      ...
      function getDirective(directiveNode) {
        return new _directives.GraphQLDirective({
          ...
          args: directiveNode.arguments && makeInputValues(
      ...
      function makeInputValues(values) {
        return (0, _keyValMap2.default)(values, function (value) {
          ...
          return {
            ...
            defaultValue: (0, _valueFromAST.valueFromAST)(value.defaultValue,
                type)
          };
        });
      }
    ...
    function getDeprecationReason(directives) {
      var deprecatedAST = directives && (0, _find2.default)(directives,
          function (directive) {
            return directive.name.value
                === _directives.GraphQLDeprecatedDirective.name;
          });
      if (!deprecatedAST) {
        return;
      }
      ...
      var _getArgumentValues = (0, _values.getArgumentValues)(
          _directives.GraphQLDeprecatedDirective, deprecatedAST),
    ...
    function getDescription(node) {
      ...
      while (token && token.kind === _lexer.TokenKind.COMMENT && token.next
      && token.prev && token.line + 1 === token.next.line && token.line
      !== token.prev.line) {
    ...
    function isValidJSValue(value, type) {
      ...
      if (type instanceof _definition.GraphQLInputObjectType) {
        var _ret3 = function () {
          ...
          // Ensure every defined field is valid.
          Object.keys(fields).forEach(function (fieldName) {
            var newErrors = isValidJSValue(value[fieldName],
      ...
      try {
        ...
        if ((0, _isNullish2.default)(parseResult)) {
          return ['Expected type "' + type.name + '", found ' + JSON.stringify(
              value) + '.'];
        }
      } catch (error) {
        return ['Expected type "' + type.name + '", found ' + JSON.stringify(
...
// Spec Section: "Lone Anonymous Operation"
    var specifiedRules = exports.specifiedRules = [_UniqueOperationNames.UniqueOperationNames,
      ...
      _VariablesAreInputTypes.VariablesAreInputTypes, _ScalarLeafs.ScalarLeafs,
...
// Spec Section: "Operation Name Uniqueness"
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function validate(schema, ast, rules) {
      ...
      return visitUsingRules(schema, typeInfo, ast,
    ...
    function visitUsingRules(schema, typeInfo, documentAST, rules) {
      ...
      (0, _visitor.visit)(documentAST, (0, _visitor.visitWithTypeInfo)(typeInfo,
            ...
            (0, _visitor.visit)(node,
                (0, _visitor.visitWithTypeInfo)(typeInfo, {
                  ...
                  Variable: function Variable(variable) {
                    newUsages.push(
                        {node: variable, type: typeInfo.getInputType()});
                  }
                }));
            usages = newUsages;
      ...
      ValidationContext.prototype.getRecursiveVariableUsages = function getRecursiveVariableUsages(operation) {
        ...
        if (!usages) {
          ...
          for (var i = 0; i < fragments.length; i++) {
            Array.prototype.push.apply(usages,
...
//# sourceMappingURL=fetcher.js.map
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function locatedError(originalError, nodes, path) {
      ...
      var message = originalError ? originalError.message || String(
          originalError) : 'An unknown error occurred.';
      return new _GraphQLError.GraphQLError(message,
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function syntaxError(source, position, description) {
      ...
      var error = new _GraphQLError.GraphQLError(
          ...
          + highlightSourceAtLocation(source, location), undefined, source,
          [position]);
      return error;
    }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function graphql(schema, requestString, rootValue, contextValue,
      ...
      return new Promise(function (resolve) {
        ...
        if (validationErrors.length > 0) {
          ...
          resolve((0, _execute.execute)(schema, documentAST, rootValue,
              contextValue, variableValues, operationName));
        }
      }).then(undefined, function (error) {
        return {errors: [error]};
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function buildClientSchema(introspection) {
      ...
      var typeIntrospectionMap = (0, _keyMap2.default)(
          schemaIntrospection.types, function (type) {
            return type.name;
          });
      ...
      function getNamedType(typeName) {
        ...
        if (!typeIntrospection) {
          throw new Error(
              'Invalid or incomplete schema, unknown type: ' + typeName
              + '. Ensure '
      ...
      function buildType(type) {
        switch (type.kind) {
          ...
          default:
            throw new Error(
                'Invalid or incomplete schema, unknown kind: ' + type.kind
                + '. Ensure '
                + 'that a full introspection query is used in order to build a '
                + 'client schema.');
        }
      ...
      function buildEnumDef(enumIntrospection) {
        return new _definition.GraphQLEnumType({
          ...
          values: (0, _keyValMap2.default)(enumIntrospection.enumValues,
      ...
      function buildFieldDefMap(typeIntrospection) {
        return (0, _keyValMap2.default)(typeIntrospection.fields,
      ...
      function buildInputValueDefMap(inputValueIntrospections) {
        return (0, _keyValMap2.default)(inputValueIntrospections,
            function (inputValue) {
      ...
      function buildDirective(directiveIntrospection) {
        ...
        var locations = directiveIntrospection.locations
            ? directiveIntrospection.locations.slice() : [].concat(
      ...
      var mutationType = schemaIntrospection.mutationType ? getObjectType(
          schemaIntrospection.mutationType) : null;

      var subscriptionType = schemaIntrospection.subscriptionType
          ? getObjectType(schemaIntrospection.subscriptionType) : null;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function extendSchema(schema, documentAST) {
      ...
      (0, _invariant2.default)(
          documentAST && documentAST.kind === _kinds.DOCUMENT,
        ...
        switch (def.kind) {
          ...
          case _kinds.INPUT_OBJECT_TYPE_DEFINITION:
            ...
            if (schema.getType(typeName)) {
              throw new _GraphQLError.GraphQLError('Type "' + typeName
                  + '" already exists in the schema. It cannot also '
          ...
          case _kinds.TYPE_EXTENSION_DEFINITION:
            ...
            if (!existingType) {
              throw new _GraphQLError.GraphQLError(
                  'Cannot extend type "' + extendedTypeName
          ...
          case _kinds.DIRECTIVE_DEFINITION:
            ...
            if (existingDirective) {
              throw new _GraphQLError.GraphQLError('Directive "' + directiveName
                  + '" already exists in the schema. It '
                  + 'cannot be redefined.', [def]);
            }
      ...
      if (Object.keys(typeExtensionsMap).length === 0 && Object.keys(
          typeDefinitionMap).length === 0 && directiveDefinitions.length
          === 0) {
        return schema;
      }
      ...
      var mutationType = existingMutationType ? getTypeFromDef(
          existingMutationType) : null;

      var existingSubscriptionType = schema.getSubscriptionType();
      var subscriptionType = existingSubscriptionType ? getTypeFromDef(
          existingSubscriptionType) : null;
      ...
      function getMergedDirectives() {
        ...
        (0, _invariant2.default)(existingDirectives,
      ...
      function getDirective(directiveNode) {
        return new _directives.GraphQLDirective({
          ...
          args: directiveNode.arguments && buildInputValues(
              directiveNode.arguments)
        });
      }

      function buildImplementedInterfaces(typeNode) {
        return typeNode.interfaces && typeNode.interfaces.map(
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function findBreakingChanges(oldSchema, newSchema) {
      return [].concat(findRemovedTypes(oldSchema, newSchema),
      ...
      Object.keys(oldTypeMap).forEach(function (typeName) {
        ...
        if (!(oldType instanceof newType.constructor)) {
          breakingChanges.push({
            ...
            description: typeName + ' changed from ' + (typeKindName(oldType)
    ...
    function findFieldsThatChangedType(oldSchema, newSchema) {
      ...
      Object.keys(oldTypeMap).forEach(function (typeName) {
        ...
        if (!(oldType instanceof _definition.GraphQLObjectType || oldType
            instanceof _definition.GraphQLInterfaceType || oldType
            instanceof _definition.GraphQLInputObjectType) || !(newType
            instanceof oldType.constructor)) {
          return;
        }
        ...
        Object.keys(oldTypeFieldsDef).forEach(function (fieldName) {
          ...
          if (!(fieldName in newTypeFieldsDef)) {
            ...
            var oldFieldType = (0, _definition.getNamedType)(
                oldTypeFieldsDef[fieldName].type);
            var newFieldType = (0, _definition.getNamedType)(
                newTypeFieldsDef[fieldName].type);
            if (oldFieldType && newFieldType && oldFieldType.name
                !== newFieldType.name) {
              breakingFieldChanges.push({
        ...
        oldType.getValues().forEach(function (value) {
          if (!valuesInNewEnum[value.name]) {
            valuesRemovedFromEnums.push({
              ...
              description: value.name + ' was removed from enum type '
                  + typeName + '.'
            });
          }
        });
          ...
          if (fieldDef && fieldDef.isDeprecated) {
            ...
            if (parentType) {
              ...
              errors.push(new _GraphQLError.GraphQLError(
                  'The field ' + parentType.name + '.' + fieldDef.name
        ...
        EnumValue: function EnumValue(node) {
          ...
          if (enumVal && enumVal.isDeprecated) {
            ...
            if (type) {
              ...
              errors.push(new _GraphQLError.GraphQLError(
                  'The enum value ' + type.name + '.' + enumVal.name
                  + ' is deprecated.' + (reason ? ' ' + reason : ''), [node]));
            }
          }
        }
      ...
      for (var i = 0; i < documentAST.definitions.length; i++) {
        ...
        if (definition.kind === _kinds.OPERATION_DEFINITION) {
          if (!operationName) {
            ...
            operation = definition;
          } else if (definition.name && definition.name.value
              === operationName) {
            return definition;
          }
        }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function isBuiltInScalar(typename) {
      return typename === 'String' || typename === 'Boolean' || typename
          === 'Int' || typename === 'Float' || typename === 'ID';
    }
    ...
    function printFilteredSchema(schema, directiveFilter, typeFilter) {
      ...
      var typeMap = schema.getTypeMap();
      var types = Object.keys(typeMap).filter(typeFilter).sort(
      ...
      return [printSchemaDefinition(schema)].concat(
          directives.map(printDirective), types.map(printType)).filter(
          Boolean).join('\n\n') + '\n';
    }
    ...
    function printObject(type) {
      ...
      var implementedInterfaces = interfaces.length ? ' implements '
          + interfaces.map(function (i) {
            return i.name;
          }).join(', ') : '';
      return printDescription(type) + ('type ' + type.name
    ...
    function printUnion(type) {
      return printDescription(type) + ('union ' + type.name + ' = '
          + type.getTypes().join(' | '));
    }
    ...
    function printEnumValues(values) {
      return values.map(function (value, i) {
        return printDescription(value, '  ', !i) + '  ' + value.name
    ...
    function printFields(type) {
      ...
      return fields.map(function (f, i) {
        return printDescription(f, '  ', !i) + '  ' + f.name + printArgs(f.args,
            '  ') + ': ' + String(f.type) + printDeprecated(f);
      }).join('\n');
    }

    function printArgs(args) {
      var indentation = arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1] : '';
      ...
      return '(\n' + args.map(function (arg, i) {
        return printDescription(arg, '  ' + indentation, !i) + '  '
    ...
    function printDirective(directive) {
      return printDescription(directive) + 'directive @' + directive.name
          + printArgs(directive.args) + ' on ' + directive.locations.join(
              ' | ');
    }
    ...
    function printDescription(def) {
      var indentation = arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1] : '';
      var firstInBlock = arguments.length > 2 && arguments[2] !== undefined
          ? arguments[2] : true;
    ...
    function separateOperations(documentAST) {
      ...
      (0, _visitor.visit)(documentAST, {
        ...
        FragmentSpread: function FragmentSpread(node) {
          ...
          (depGraph[fromName] || (depGraph[fromName] = Object.create(
              null)))[toName] = true;
        }
      });
      ...
      operations.forEach(function (operation) {
        ...
        separatedDocumentASTs[operationName] = {
          ...
          definitions: documentAST.definitions.filter(function (def) {
            return def === operation || def.kind === 'FragmentDefinition'
                && dependencies[def.name.value];
          })
        };
      });
...
// recursing through a dependency graph.
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function badValueMessage(argName, type, value, verboseErrors) {
      ...
      return 'Argument "' + argName + '" has invalid value ' + value + '.'
          + message;
    }
        ...
        Argument: function Argument(node) {
          ...
          if (argDef) {
            var errors = (0, _isValidLiteralValue.isValidLiteralValue)(
                argDef.type, node.value);
            if (errors && errors.length > 0) {
              context.reportError(new _error.GraphQLError(
                  badValueMessage(node.name.value, argDef.type,
                      (0, _printer.print)(node.value), errors), [node.value]));
            }
          }
          return false;
        }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function defaultForNonNullArgMessage(varName, type, guessType) {
      return 'Variable "$' + varName + '" of type "' + String(type)
          + '" is required and ' + 'will not use the default value. '
    ...
    function badValueForDefaultArgMessage(varName, type, value, verboseErrors) {
      var message = verboseErrors ? '\n' + verboseErrors.join('\n') : '';
      return 'Variable "$' + varName + '" of type "' + String(type)
          + '" has invalid ' + ('default value ' + value + '.' + message);
    }
      ...
      return {
        VariableDefinition: function VariableDefinition(node) {
          ...
          if (type && defaultValue) {
            var errors = (0, _isValidLiteralValue.isValidLiteralValue)(type,
                defaultValue);
            if (errors && errors.length > 0) {
              context.reportError(new _error.GraphQLError(
                  badValueForDefaultArgMessage(name, type,
                      (0, _printer.print)(defaultValue), errors),
                  [defaultValue]));
            }
          }
          return false;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function undefinedFieldMessage(fieldName, type, suggestedTypeNames,
        suggestedFieldNames) {
      ...
      if (suggestedTypeNames.length !== 0) {
        ...
        message += ' Did you mean ' + (0, _quotedOrList2.default)(
            suggestedFieldNames) + '?';
      }
      return message;
    }
        ...
        Field: function Field(node) {
          ...
          if (type) {
            ...
            if (!fieldDef) {
              ...
              var suggestedTypeNames = getSuggestedTypeNames(schema, type,
                  fieldName);
              // If there are no suggested types, then perhaps this was a typo?
              var suggestedFieldNames = suggestedTypeNames.length !== 0 ? []
                  : getSuggestedFieldNames(schema, type, fieldName);

              // Report an error, including helpful suggestions.
              context.reportError(new _error.GraphQLError(
                  undefinedFieldMessage(fieldName, type.name,
                      suggestedTypeNames, suggestedFieldNames), [node]));
            }
          }
        }
      };
    ...
    function getSuggestedTypeNames(schema, type, fieldName) {
      if (type instanceof _definition.GraphQLInterfaceType || type
        ...
        var _ret = function () {
          ...
          var suggestedInterfaceTypes = Object.keys(interfaceUsageCount).sort(
              function (a, b) {
    ...
    function FragmentsOnCompositeTypes(context) {
      return {
        InlineFragment: function InlineFragment(node) {
          ...
          if (node.typeCondition && type && !(0, _definition.isCompositeType)(
              type)) {
            context.reportError(new _error.GraphQLError(
        ...
        FragmentDefinition: function FragmentDefinition(node) {
          ...
          if (type && !(0, _definition.isCompositeType)(type)) {
            context.reportError(new _error.GraphQLError(
                fragmentOnNonCompositeErrorMessage(node.name.value,
                    (0, _printer.print)(node.typeCondition)),
                [node.typeCondition]));
          }
        }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function unknownArgMessage(argName, fieldName, type, suggestedArgs) {
      var message = 'Unknown argument "' + argName + '" on field "' + fieldName
          + '" of ' + ('type "' + String(type) + '".');
    ...
    function unknownDirectiveArgMessage(argName, directiveName, suggestedArgs) {
      var message = 'Unknown argument "' + argName + '" on directive "@'
          + directiveName + '".';
      if (suggestedArgs.length) {
        message += ' Did you mean ' + (0, _quotedOrList2.default)(suggestedArgs)
            + '?';
      ...
      return {
        Argument: function Argument(node, key, parent, path, ancestors) {
          ...
          if (argumentOf.kind === _kinds.FIELD) {
            var fieldDef = context.getFieldDef();
            if (fieldDef) {
              var fieldArgDef = (0, _find2.default)(fieldDef.args,
                  function (arg) {
                    return arg.name === node.name.value;
                  });
              if (!fieldArgDef) {
                ...
                context.reportError(new _error.GraphQLError(
                    unknownArgMessage(node.name.value, fieldDef.name,
                        parentType.name,
                        (0, _suggestionList2.default)(node.name.value,
            ...
            if (directive) {
              var directiveArgDef = (0, _find2.default)(directive.args,
                  function (arg) {
                    return arg.name === node.name.value;
                  });
              if (!directiveArgDef) {
      ...
      return {
        Directive: function Directive(node, key, parent, path, ancestors) {
          var directiveDef = (0, _find2.default)(
              context.getSchema().getDirectives(), function (def) {
                return def.name === node.name.value;
              });
          if (!directiveDef) {
            context.reportError(new _error.GraphQLError(
                unknownDirectiveMessage(node.name.value), [node]));
            return;
          }
          var candidateLocation = getDirectiveLocationForASTPath(ancestors);
          if (!candidateLocation) {
            context.reportError(new _error.GraphQLError(
                misplacedDirectiveMessage(node.name.value, node.type), [node]));
    ...
    function KnownFragmentNames(context) {
      return {
        FragmentSpread: function FragmentSpread(node) {
          ...
          if (!fragment) {
            context.reportError(
                new _error.GraphQLError(unknownFragmentMessage(fragmentName),
                    [node.name]));
          }
        }
      };
          ...
          if (!type) {
            context.reportError(new _error.GraphQLError(
                unknownTypeMessage(typeName,
                    (0, _suggestionList2.default)(typeName,
                        Object.keys(schema.getTypeMap()))), [node]));
          }
        }
      };
    }
      ...
      return {
        ...
        OperationDefinition: function OperationDefinition(node) {
          if (!node.name && operationCount > 1) {
            context.reportError(
                new _error.GraphQLError(anonOperationNotAloneMessage(),
                    [node]));
          }
        }
      };
      ...
      function detectCycleRecursive(fragment) {
        ...
        for (var i = 0; i < spreadNodes.length; i++) {
          ...
          if (cycleIndex === undefined) {
            ...
            context.reportError(new _error.GraphQLError(
                cycleErrorMessage(spreadName, cyclePath.map(function (s) {
                  return s.name.value;
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function undefinedVarMessage(varName, opName) {
      return opName ? 'Variable "$' + varName
          + '" is not defined by operation "' + opName + '".' : 'Variable "$'
          ...
          leave: function leave() {
            ...
            fragmentDefs.forEach(function (fragmentDef) {
              ...
              if (fragmentNameUsed[fragName] !== true) {
                context.reportError(
                    new _error.GraphQLError(unusedFragMessage(fragName),
                        [fragmentDef]));
              }
            });
          }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function unusedVariableMessage(varName, opName) {
      return opName ? 'Variable "$' + varName + '" is never used in operation "'
          + opName + '".' : 'Variable "$' + varName + '" is never used.';
    }
      ...
      if (Array.isArray(reason)) {
        return reason.map(function (_ref) {
          var responseName = _ref[0],
              subreason = _ref[1];
          return 'subfields "' + responseName + '" conflict because '
    ...
    function OverlappingFieldsCanBeMerged(context) {
      ...
      return {
        SelectionSet: function SelectionSet(selectionSet) {
          var conflicts = findConflictsWithinSelectionSet(context,
              cachedFieldsAndFragmentNames, comparedFragments,
          ...
          conflicts.forEach(function (_ref2) {
            var _ref2$ = _ref2[0],
                ...
                fields1 = _ref2[1],
                fields2 = _ref2[2];
            return context.reportError(new _error.GraphQLError(
...
// GraphQL Document.
    function findConflictsWithinSelectionSet(context,
        cachedFieldsAndFragmentNames, comparedFragments, parentType,
        selectionSet) {
      var conflicts = [];

      var _getFieldsAndFragment = getFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, parentType, selectionSet),
      ...
      collectConflictsWithin(context, conflicts, cachedFieldsAndFragmentNames,
          comparedFragments, fieldMap);

      // (B) Then collect conflicts between these fields and those represented by
      // each spread fragment name found.
      for (var i = 0; i < fragmentNames.length; i++) {
        collectConflictsBetweenFieldsAndFragment(context, conflicts,
            cachedFieldsAndFragmentNames, comparedFragments, false, fieldMap,
            fragmentNames[i]);
        ...
        for (var j = i + 1; j < fragmentNames.length; j++) {
          collectConflictsBetweenFragments(context, conflicts,
              cachedFieldsAndFragmentNames, comparedFragments, false,
              fragmentNames[i], fragmentNames[j]);
        }
      }
      return conflicts;
    }
...
// including via spreading in any nested fragments.
    function collectConflictsBetweenFieldsAndFragment(context, conflicts,
        cachedFieldsAndFragmentNames, comparedFragments, areMutuallyExclusive,
        fieldMap, fragmentName) {
      var fragment = context.getFragment(fragmentName);
      if (!fragment) {
        return;
      }

      var _getReferencedFieldsA = getReferencedFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, fragment),
      ...
      collectConflictsBetween(context, conflicts, cachedFieldsAndFragmentNames,
          comparedFragments, areMutuallyExclusive, fieldMap, fieldMap2);
      ...
      for (var i = 0; i < fragmentNames2.length; i++) {
        collectConflictsBetweenFieldsAndFragment(context, conflicts,
            cachedFieldsAndFragmentNames, comparedFragments,
            areMutuallyExclusive, fieldMap, fragmentNames2[i]);
      }
    }

// Collect all conflicts found between two fragments, including via spreading in
// any nested fragments.
    function collectConflictsBetweenFragments(context, conflicts,
        cachedFieldsAndFragmentNames, comparedFragments, areMutuallyExclusive,
      ...
      if (comparedFragments.has(fragmentName1, fragmentName2,
          areMutuallyExclusive)) {
        return;
      }
      comparedFragments.add(fragmentName1, fragmentName2, areMutuallyExclusive);

      var _getReferencedFieldsA2 = getReferencedFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, fragment1),
          fieldMap1 = _getReferencedFieldsA2[0],
          fragmentNames1 = _getReferencedFieldsA2[1];

      var _getReferencedFieldsA3 = getReferencedFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, fragment2),
      ...
      collectConflictsBetween(context, conflicts, cachedFieldsAndFragmentNames,
          comparedFragments, areMutuallyExclusive, fieldMap1, fieldMap2);
...
// between the sub-fields of two overlapping fields.
    function findConflictsBetweenSubSelectionSets(context,
        cachedFieldsAndFragmentNames, comparedFragments, areMutuallyExclusive,
        parentType1, selectionSet1, parentType2, selectionSet2) {
      var conflicts = [];

      var _getFieldsAndFragment2 = getFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, parentType1, selectionSet1),
          fieldMap1 = _getFieldsAndFragment2[0],
          fragmentNames1 = _getFieldsAndFragment2[1];

      var _getFieldsAndFragment3 = getFieldsAndFragmentNames(context,
          cachedFieldsAndFragmentNames, parentType2, selectionSet2),
      ...
      for (var j = 0; j < fragmentNames2.length; j++) {
        collectConflictsBetweenFieldsAndFragment(context, conflicts,
            cachedFieldsAndFragmentNames, comparedFragments,
            areMutuallyExclusive, fieldMap1, fragmentNames2[j]);
      }
      ...
      for (var i = 0; i < fragmentNames1.length; i++) {
        collectConflictsBetweenFieldsAndFragment(context, conflicts,
            cachedFieldsAndFragmentNames, comparedFragments,
            areMutuallyExclusive, fieldMap2, fragmentNames1[i]);
      }
...
// Collect all Conflicts "within" one collection of fields.
    function collectConflictsWithin(context, conflicts,
        cachedFieldsAndFragmentNames, comparedFragments, fieldMap) {
        ...
        if (fields.length > 1) {
          for (var i = 0; i < fields.length; i++) {
            for (var j = i + 1; j < fields.length; j++) {
              var conflict = findConflict(context, cachedFieldsAndFragmentNames,
                  comparedFragments, false, // within one collection is never mutually exclusive
...
// each individual selection set.
    function collectConflictsBetween(context, conflicts,
        cachedFieldsAndFragmentNames, comparedFragments,
        ...
        if (fields2) {
          ...
          for (var i = 0; i < fields1.length; i++) {
            for (var j = 0; j < fields2.length; j++) {
              var conflict = findConflict(context, cachedFieldsAndFragmentNames,
                  comparedFragments, parentFieldsAreMutuallyExclusive,
                  responseName, fields1[i], fields2[j]);
              if (conflict) {
                conflicts.push(conflict);
              }
            }
...
// comparing their sub-fields.
    function findConflict(context, cachedFieldsAndFragmentNames,
        comparedFragments, parentFieldsAreMutuallyExclusive, responseName,
        field1, field2) {
      ...
      var areMutuallyExclusive = parentFieldsAreMutuallyExclusive || parentType1
          !== parentType2 && parentType1
          instanceof _definition.GraphQLObjectType && parentType2
          instanceof _definition.GraphQLObjectType;
      ...
      if (!areMutuallyExclusive) {
        ...
        if (name1 !== name2) {
          return [[responseName,
            name1 + ' and ' + name2 + ' are different fields'], [node1],
            [node2]];
        }

        // Two field calls must have the same arguments.
        if (!sameArguments(node1.arguments || [], node2.arguments || [])) {
          return [[responseName, 'they have differing arguments'], [node1],
            [node2]];
        }
      }
      ...
      if (type1 && type2 && doTypesConflict(type1, type2)) {
        return [[responseName,
          'they return conflicting types ' + String(type1) + ' and ' + String(
              type2)], [node1], [node2]];
      }
      ...
      if (selectionSet1 && selectionSet2) {
        var conflicts = findConflictsBetweenSubSelectionSets(context,
            cachedFieldsAndFragmentNames, comparedFragments,
            areMutuallyExclusive, (0, _definition.getNamedType)(type1),
            selectionSet1, (0, _definition.getNamedType)(type2), selectionSet2);
    ...
    function sameValue(value1, value2) {
      return !value1 && !value2 || (0, _printer.print)(value1)
...
// later recursively. However List and Non-Null types must match.
    function doTypesConflict(type1, type2) {
      if (type1 instanceof _definition.GraphQLList) {
        return type2 instanceof _definition.GraphQLList ? doTypesConflict(
            type1.ofType, type2.ofType) : true;
      }
      if (type2 instanceof _definition.GraphQLList) {
        return type1 instanceof _definition.GraphQLList ? doTypesConflict(
            type1.ofType, type2.ofType) : true;
      }
      if (type1 instanceof _definition.GraphQLNonNull) {
        return type2 instanceof _definition.GraphQLNonNull ? doTypesConflict(
            type1.ofType, type2.ofType) : true;
      }
      if (type2 instanceof _definition.GraphQLNonNull) {
        return type1 instanceof _definition.GraphQLNonNull ? doTypesConflict(
            type1.ofType, type2.ofType) : true;
      }
...
// referenced via fragment spreads.
    function getFieldsAndFragmentNames(context, cachedFieldsAndFragmentNames,
        parentType, selectionSet) {
      var cached = cachedFieldsAndFragmentNames.get(selectionSet);
      if (!cached) {
        var nodeAndDefs = {};
        var fragmentNames = {};
        _collectFieldsAndFragmentNames(context, parentType, selectionSet,
            nodeAndDefs, fragmentNames);
...
// as well as a list of nested fragment names referenced via fragment spreads.
    function getReferencedFieldsAndFragmentNames(context,
        cachedFieldsAndFragmentNames, fragment) {
      ...
      return getFieldsAndFragmentNames(context, cachedFieldsAndFragmentNames,
          fragmentType, fragment.selectionSet);
    }

    function _collectFieldsAndFragmentNames(context, parentType, selectionSet,
        nodeAndDefs, fragmentNames) {
      for (var i = 0; i < selectionSet.selections.length; i++) {
        var selection = selectionSet.selections[i];
        switch (selection.kind) {
          case _kinds.FIELD:
            ...
            var fieldDef = void 0;
            if (parentType instanceof _definition.GraphQLObjectType
                || parentType instanceof _definition.GraphQLInterfaceType) {
              fieldDef = parentType.getFields()[fieldName];
            }
            var responseName = selection.alias ? selection.alias.value
                : fieldName;
          ...
          case _kinds.INLINE_FRAGMENT:
            ...
            var inlineFragmentType = typeCondition
                ? (0, _typeFromAST.typeFromAST)(context.getSchema(),
...
// a single Conflict.
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function typeIncompatibleSpreadMessage(fragName, parentType, fragType) {
      return 'Fragment "' + fragName + '" cannot be spread here as objects of '
          + ('type "' + String(parentType) + '" can never be of type "'
              + String(fragType) + '".');
    }

    function typeIncompatibleAnonSpreadMessage(parentType, fragType) {
      return 'Fragment cannot be spread here as objects of ' + ('type "'
          + String(parentType) + '" can never be of type "' + String(fragType)
          + '".');
    }
      ...
      return {
        InlineFragment: function InlineFragment(node) {
          ...
          if (fragType && parentType && !(0, _typeComparators.doTypesOverlap)(
              context.getSchema(), fragType, parentType)) {
            context.reportError(new _error.GraphQLError(
    ...
    function getFragmentType(context, name) {
      ...
      return frag && (0, _typeFromAST.typeFromAST)(context.getSchema(),
          frag.typeCondition);
    }
        ...
        Field: {
          ...
          leave: function leave(node) {
            ...
            fieldDef.args.forEach(function (argDef) {
              ...
              if (!argNode && argDef.type
                  instanceof _definition.GraphQLNonNull) {
                context.reportError(new _error.GraphQLError(
                    missingFieldArgMessage(node.name.value, argDef.name,
                        argDef.type), [node]));
              }
            });
          }
          ...
          leave: function leave(node) {
            ...
            directiveDef.args.forEach(function (argDef) {
              ...
              if (!argNode && argDef.type
                  instanceof _definition.GraphQLNonNull) {
                context.reportError(new _error.GraphQLError(
                    missingDirectiveArgMessage(node.name.value, argDef.name,
                        argDef.type), [node]));
              }
            });
          }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function requiredSubselectionMessage(fieldName, type) {
      return 'Field "' + fieldName + '" of type "' + String(type)
        ...
        Field: function Field(node) {
          ...
          if (type) {
            if ((0, _definition.isLeafType)(type)) {
              ...
              context.reportError(new _error.GraphQLError(
                  requiredSubselectionMessage(node.name.value, type), [node]));
            }
          }
        }
      };
      ...
      return {
        ...
        Argument: function Argument(node) {
          ...
          if (knownArgNames[argName]) {
            context.reportError(
                new _error.GraphQLError(duplicateArgMessage(argName),
      ...
      return {
        ...
        ObjectField: function ObjectField(node) {
          ...
          if (knownNames[fieldName]) {
            context.reportError(
                new _error.GraphQLError(duplicateInputFieldMessage(fieldName),
      ...
      return {
        ...
        VariableDefinition: function VariableDefinition(node) {
          ...
          if (knownVariableNames[variableName]) {
            context.reportError(
                new _error.GraphQLError(duplicateVariableMessage(variableName),
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function nonInputTypeOnVarMessage(variableName, typeName) {
      return 'Variable "$' + variableName + '" cannot be non-input type "'
          + typeName + '".';
    }
    ...
    function VariablesAreInputTypes(context) {
      return {
        VariableDefinition: function VariableDefinition(node) {
          var type = (0, _typeFromAST.typeFromAST)(context.getSchema(),
              node.type);
          ...
          if (type && !(0, _definition.isInputType)(type)) {
            var variableName = node.variable.name.value;
            context.reportError(new _error.GraphQLError(
                nonInputTypeOnVarMessage(variableName,
                    (0, _printer.print)(node.type)), [node.type]));
          }
        }
      };
    }
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    function badVarPosMessage(varName, varType, expectedType) {
      return 'Variable "$' + varName + '" of type "' + String(varType)
          + '" used in ' + ('position expecting type "' + String(expectedType)
              + '".');
    }
          ...
          leave: function leave(operation) {
            ...
            usages.forEach(function (_ref) {
              ...
              if (varDef && type) {
                ...
                var schema = context.getSchema();
                var varType = (0, _typeFromAST.typeFromAST)(schema,
                    varDef.type);
                if (varType && !(0, _typeComparators.isTypeSubTypeOf)(schema,
                    effectiveType(varType, varDef), type)) {
                  context.reportError(new _error.GraphQLError(
...
// If a variable definition has a default value, it's effectively non-null.
    function effectiveType(varType, varDef) {
      return !varDef.defaultValue || varType
      instanceof _definition.GraphQLNonNull ? varType
