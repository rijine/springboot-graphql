...
public enum ExtSqlMethod {
  ...
  DELETE_BY_ID("deleteById", "根据ID 删除一条数据",
      "<script>\nDELETE %s, %s FROM %s left join %s on %s = %s WHERE %s=#{%s}\n</script>"),
  DELETE_BY_MAP("deleteByMap", "根据columnMap 条件删除记录",
      "<script>\nDELETE %s, %s FROM %s left join %s on %s = %s %s\n</script>"),
  DELETE("delete", "根据 entity 条件删除记录",
      "<script>\nDELETE %s, %s FROM %s left join %s on %s = %s %s %s\n</script>"),
  DELETE_BATCH_BY_IDS("deleteBatchIds", "根据ID集合，批量删除数据",
      "<script>\nDELETE %s, %s FROM %s left join %s on %s = %s WHERE %s IN (%s)\n</script>"),

  /**
   * 逻辑删除
   */
  LOGIC_DELETE_BY_ID("deleteById", "根据ID 逻辑删除一条数据",
      "<script>\nUPDATE %s left join %s on %s = %s %s WHERE %s=#{%s} %s\n</script>"),
  LOGIC_DELETE_BY_MAP("deleteByMap", "根据columnMap 条件逻辑删除记录",
      "<script>\nUPDATE %s left join %s on %s = %s %s %s\n</script>"),
  LOGIC_DELETE("delete", "根据 entity 条件逻辑删除记录",
      "<script>\nUPDATE %s left join %s on %s = %s %s %s %s\n</script>"),
  LOGIC_DELETE_BATCH_BY_IDS("deleteBatchIds", "根据ID集合，批量逻辑删除数据",
      "<script>\nUPDATE %s left join %s on %s = %s %s WHERE %s IN (%s) %s\n</script>"),
   ...
   * 逻辑删除 -> 查询
   */
  LOGIC_SELECT_BY_ID("selectById", "根据ID 查询一条数据",
      "SELECT %s FROM %s left join %s on %s = %s WHERE %s=#{%s} %s"),
  LOGIC_SELECT_BATCH_BY_IDS("selectBatchIds", "根据ID集合，批量查询数据",
      "<script>\nSELECT %s FROM %s left join %s on %s = %s WHERE %s IN (%s) %s\n</script>");
