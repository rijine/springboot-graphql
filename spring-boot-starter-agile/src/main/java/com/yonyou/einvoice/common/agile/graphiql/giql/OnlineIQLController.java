package com.yonyou.einvoice.common.agile.graphiql.giql;
...
@Slf4j
@Controller
public class OnlineIQLController {
  ...
  @Autowired
  private OnlineIQLProperties graphiQLProperties;
  ...
  @GetMapping(value = "${metadata.onlineiql.mapping:/onlineiql}")
  public void graphiql(HttpServletRequest request, HttpServletResponse response,
    ...
    if (graphiQLProperties.isEnable()) {
